...
`;
            ...
            const shouldEmitEol = !isEndTrimable && !isLastToken && !isFirstToken && !isLastNewLine && lastType !== TokenType.Comma && lastType !== TokenType.EndOfLine && lastType !== TokenType.LeftBrace && lastType !== TokenType.LeftBracket && lastType !== TokenType.LeftParenthes;
            if (shouldEmitEol) {
              this.tokens.push(new Token(TokenType.EndOfLine, `
`, start));
            } else {
              this.tokens.push(new Token(TokenType.IrrelevantToken, `
`, start));
            }
          } else {
